...
for(ft in FTs){
  ...
  iapesca::plot_Paths(boat.paths = posForMl[ posForMl$FISHING_TRIP_FK %in% ft, ], 
                      quanti = NULL, 
                      Create.BgMap = FALSE, 
                      gears.hauled = Nets.op$nets[ Nets.op$nets$FT_Hauling %in% ft, ], 
                      gears.set = Nets.op$nets[  Nets.op$nets$FT_Setting %in% ft, ], 
                      main = sprintf("Observed_FT_%s", ft))
  iapesca::plot_Paths(boat.paths =  posForMl[ posForMl$FISHING_TRIP_FK %in% ft, ], 
                      quanti = NULL, 
                      Create.BgMap = FALSE, 
                      gears.hauled = Nets.op.pred$nets[ Nets.op.pred$nets$FT_Hauling %in% ft, ],
                      gears.set = Nets.op.pred$nets[  Nets.op.pred$nets$FT_Setting %in% ft, ], 
                      main =  sprintf("Predicted_FT_%s", ft))
