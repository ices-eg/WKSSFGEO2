...
```{r prep data, eval=TRUE, cache = TRUE}
...
prepdat$trip_HMM_speed_beh <- factor(ifelse(prepdat$viterbi_speed==3, "Hauling", "NotFishing"),
                                     levels = prepdat$FishingOperation %>% unique %>% sort)
```
...
prepdat$trip_HMM_speed_angle_beh <- factor(ifelse(prepdat$viterbi_speed_angle==3, 
                                           "Hauling", "NotFishing"),
                                    levels = prepdat$FishingOperation %>% unique %>% sort)

names(prepdat)
prepdat <- prepdat %>% dplyr::select(-c("viterbi_speed","viterbi_speed_angle"))
